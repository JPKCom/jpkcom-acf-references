    ...
    <div id="primary" class="content-area">
        ...
        <main id="main" class="site-main">
            ...
            <div class="p-5 text-center bg-body-tertiary rounded mb-4">
                <h1 class="entry-title display-4 mb-4"><?php echo esc_html__( 'Customer overview', 'jpkcom-acf-references' ); ?></h1>
            </div>

            <!-- Customers List -->
            <?php if (have_posts()) : while (have_posts()) : the_post(); ?>

                <article id="customer-<?php the_ID(); ?>" class="jpkcom-acf-reference--item card horizontal p-0 mb-4">
                            ...
                            <header class="card-header">
                                ...
                                <div class="d-flex justify-content-start gap-3">
                                    ...
                                    <a class="text-body text-decoration-none" href="<?php the_permalink(); ?>">
                                        <?php the_title('<h2 class="customer-title h4">', '</h2>'); ?>
                                    </a>
            ...
            <?php else : ?>
                <div class="alert alert-info" role="alert">
                    <p><?php echo esc_html__( 'There are currently no customers available.', 'jpkcom-acf-references' ); ?></p>
                </div>
            <?php endif; ?>
