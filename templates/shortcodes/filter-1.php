<?php
/**
 * Shortcode template: list of reference filter 1 (taxonomy terms)
 *
 * Local variables:
 * - array|WP_Term[] $terms
 * - array $atts
...
<div class="jpkcom-acf-references--filter-1<?php if ( ! empty( $class ) ) { echo ' ' . esc_attr( $class ); } ?>" <?php if ( ! empty( $style ) ) { echo 'style="' . esc_attr( $style ) . '"'; } ?>>
    ...
    ?>
        <details name="jpkcom-acf-references-filter-1" class="border rounded p-3 mb-3">
